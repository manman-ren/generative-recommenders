...
from hammer.generative_recommenders.ops.triton.triton_ragged_hstu_attention_base import (
    _RaggedAttentionBaseFunction,
    _RaggedAttentionBaseRelativeBiasFunction,
)
...
def main(
    ...
    print("seq_offsets", seq_offsets)
    print("L,h,d", L, heads, attn_dim, hidden_dim, num_targets.size(), max_seq_len, seq_offsets.numel(), seq_offsets.size())
    ...
    if not no_relative_bias:
        ...
        out2 = _RaggedAttentionBaseFunction.apply(
            max_seq_len,
            alpha,
            q,
            k,
